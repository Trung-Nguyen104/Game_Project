...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct ItemProfile {
    public const Int32 SIZE = 16;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 11699;
        hash = hash * 31 + ItemData.GetHashCode();
        hash = hash * 31 + ItemPrototype.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (ItemProfile*)ptr;
        AssetRef.Serialize(&p->ItemPrototype, serializer);
        AssetRef.Serialize(&p->ItemData, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct ItemSpawn {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Positions {
    public const Int32 SIZE = 24;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (Positions*)ptr;
        QBoolean.Serialize(&p->isSpawned, serializer);
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct MousePointerInfo : Quantum.IComponent {
    public const Int32 SIZE = 24;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + AimAngle.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (MousePointerInfo*)ptr;
        FP.Serialize(&p->AimAngle, serializer);
  ...
  public unsafe partial interface ISignalOnUseItem : ISignal {
    void OnUseItem(Frame f, ItemInfo ItemInfo);
  }
  ...
  public unsafe partial class Frame {
    ...
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.ItemSpawner>();
      BuildSignalsArrayOnComponentRemoved<Quantum.ItemSpawner>();
      BuildSignalsArrayOnComponentAdded<MapEntityLink>();
      BuildSignalsArrayOnComponentRemoved<MapEntityLink>();
      BuildSignalsArrayOnComponentAdded<Quantum.MousePointerInfo>();
      BuildSignalsArrayOnComponentRemoved<Quantum.MousePointerInfo>();
    ...
    public unsafe partial struct FrameSignals {
      public void OnPickUpItem(FPVector2 Position) {
        var array = _f._ISignalOnPickUpItemSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnPickUpItem(_f, Position);
          }
        }
      }
      public void OnUseItem(ItemInfo ItemInfo) {
        var array = _f._ISignalOnUseItemSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnUseItem(_f, ItemInfo);
          }
        }
      }
      public void OnLoadPosition(FPVector2 Position) {
        var array = _f._ISignalOnLoadPositionSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
  ...
  public unsafe partial class Statics {
    public static FrameSerializer.Delegate SerializeItemSpawn;
    public static FrameSerializer.Delegate SerializePositions;
    public static FrameSerializer.Delegate SerializeItemInfo;
    public static FrameSerializer.Delegate SerializeRoleProfile;
    public static FrameSerializer.Delegate SerializeInput;
    public static FrameSerializer.Delegate SerializeEntityRef;
    static partial void InitStaticDelegatesGen() {
      SerializeItemSpawn = Quantum.ItemSpawn.Serialize;
      SerializePositions = Quantum.Positions.Serialize;
      SerializeItemInfo = Quantum.ItemInfo.Serialize;
      SerializeRoleProfile = Quantum.RoleProfile.Serialize;
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.BitSet8), Quantum.BitSet8.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.ItemProfile), Quantum.ItemProfile.SIZE);
      typeRegistry.Register(typeof(Quantum.ItemSpawn), Quantum.ItemSpawn.SIZE);
      typeRegistry.Register(typeof(Quantum.ItemSpawner), Quantum.ItemSpawner.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.MousePointerInfo), Quantum.MousePointerInfo.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.RoleProfile), Quantum.RoleProfile.SIZE);
